...
public class Query {
    ...
    // PointsBoard instance, used to calculate and retrieve points and medals for
    // each gamer
    ...
    /**
     * Query 2: Finds the lowest-scoring match and the game within it that
     * contributed the most points.
     */
    public void printLowestScoringMatch() {
        ...
        System.out.println("Contribution: " + topGameRounds + " rounds * " + topGame.getBasePointPerRound()
                + " points = " + maxContribution);
    }
    ...
    /**
     * Query 4: Finds and prints the gamer with the highest total points, including
     * details and medal.
     */
    ...
    /**
     * Query 5: Calculates and prints the total points from all matches in the
     * tournament.
     */
